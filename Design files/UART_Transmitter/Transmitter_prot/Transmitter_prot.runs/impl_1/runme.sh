...
HD_PWD='C:/Users/chris-pc/Desktop/Crypto Accelerator/Design files/UART_Transmitter/Transmitter_prot/Transmitter_prot.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Transmitter_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Transmitter_Top.tcl -notrace
