...
HD_PWD='C:/Users/chris-pc/Desktop/Crypto Accelerator/Design files/UART_Transmitter/Transmitter_prot/Transmitter_prot.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Transmitter_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Transmitter_Top.tcl
